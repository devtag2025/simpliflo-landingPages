            ...
            <section>
                <div className="relative pt-20 sm:pt-28 md:pt-36">
                    <div
                        ...
                        className="absolute"
                        style={{
                            background: "radial-gradient(125% 125% at 50% 100%, var(--color-background) 0%, var(--color-background) 100%)"
                        }}
                    />
                    <div className="mx-auto max-w-7xl px-4 sm:px-6">
                        <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                            ...
                            <TextEffect
                                ...
                                Send WhatsApp reminders customers read, share Stripe pay links, and keep Xero or QuickBooks up to date automatically. 
                                 No spreadsheets. 
                            </TextEffect>
                            <TextEffect
                                per="line"
