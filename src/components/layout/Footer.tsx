...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full py-10 sm:py-16 flex flex-col items-center bg-gradient-to-b from-white via-purple-50 to-pink-50">
      <div className="relative w-full max-w-5xl mx-auto px-2 sm:px-4 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between items-start gap-8 lg:gap-12 mb-8 w-full">
          ...
          <div className="w-full lg:w-2/3 mb-6 lg:mb-0">
            <h3 className="text-left text-base sm:text-lg leading-snug font-normal text-gray-800 mb-3 sm:mb-4">
            ...
            <form className="mt-2 w-full" onSubmit={handleSubscribe}>
              <div className="flex items-center w-full border-b border-gray-300 focus-within:border-purple-500">
                <input
                  type="email"
                  placeholder="Email Address"
                  aria-label="Email address"
                  className="w-full px-0 py-2 text-xs sm:text-sm bg-transparent placeholder-gray-500 focus:outline-none"
                  value={email}
              ...
              {subscribed && (
                <div className="mt-2 text-green-600 text-xs font-medium">Thanks for subscribing!</div>
              )}
            </form>
          </div>
            ...
            <div className="flex flex-col items-start text-left">
              ...
              <ul className="space-y-2">
                <li>
                  <button
                    type="button"
                    className="text-xs sm:text-sm text-gray-700 hover:text-purple-600 transition-colors bg-transparent p-0"
                ...
                <li>
                  <a
                    href="/help-center"
                    className="text-xs sm:text-sm text-gray-700 hover:text-purple-600 transition-colors"
                    target="_blank"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-gray-200 text-xs">
          <div className="flex items-center gap-4 mb-2 sm:mb-0">
            {/* Social icons */}
            <a href="https://twitter.com/simpliflow" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-purple-600 transition-colors" aria-label="Twitter">
            ...
            <a href="https://github.com/simpliflow" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-purple-600 transition-colors" aria-label="GitHub">
              <svg width="18" height="18" fill="none" viewBox="0 0 24 24">
            ...
            <a href="https://linkedin.com/company/simpliflow" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-purple-600 transition-colors" aria-label="LinkedIn">
              <svg width="18" height="18" fill="none" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-4">
            <p className="text-xs text-gray-600">
              © 2025 <span className="font-bold text-purple-700">simpliflow</span>. All rights reserved.
            </p>
